...
\ ???Code ist ungeklärt.
\ ?! ist noch nicht übersetzt in MSP430
...
folgendes aus COLD noch klären: 
  Label mem-init
    $01 , $0A bset:g
...
[then]
 ...
 \ moving datas between stacks
  ...
  \ Dabei ist i' das limit der innersten Schleife, i der Zähler, usw.
...
\ Code: :doesjump  ( in ITC nicht nötig.) 
\ end-code

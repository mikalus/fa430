...
$14A $543     (  157    00014A 0543         MOV #0,r5 ; ) 0#  5 dRn mov, .lst <0> 
$14C $1543     (   158    00014C 1543         MOV #1,r5 ; ) 1#  5 dRn mov, .lst <0> 
$14E $2543     (   159    00014E 2543         MOV #2,r5 ; ) 2#  5 dRn mov, .lst <0> 
$150 $2542     (   160    000150 2542         MOV #4,r5 ; ) 4#  5 dRn mov, .lst <0> 
$152 $3542     (   161    000152 3542         MOV #8,r5 ; ) 8#  5 dRn mov, .lst <0> 
$154 $3543     (   162    000154 3543         MOV #0xFFFF,r5 ; ) ffff#  5 dRn mov, .lst<0> 

$156 $3540 $0     (   164    000156 0543         MOV #0,r5 ; ) 0 s#k  5 dRn mov, .lst <0> 
$15A $3540 $100     (   165    000158 1543         MOV #1,r5 ; ) 1 s#k  5 dRn mov, .lst <0> 
$15E $3540 $200     (   166    00015A 2543         MOV #2,r5 ; ) 2 s#k  5 dRn mov, .lst <0> 
$162 $3540 $300     (   167    00015C 35400300     MOV #3,r5 ; ) 3 s#k  5 dRn mov, .lst <0> 
$166 $3540 $400     (   168    000160 2542         MOV #4,r5 ; ) 4 s#k  5 dRn mov, .lst <0> 
$16A $3540 $500     (   169    000162 35400500     MOV #5,r5 ; ) 5 s#k  5 dRn mov, .lst <0> 
$16E $3540 $600     (   170    000166 35400600     MOV #6,r5 ; ) 6 s#k  5 dRn mov, .lst <0> 
$172 $3540 $700     (   171    00016A 35400700     MOV #7,r5 ; ) 7 s#k  5 dRn mov, .lst <0> 
$176 $3540 $800     (   172    00016E 3542         MOV #8,r5 ; ) 8 s#k  5 dRn mov, .lst <0> 
$17A $3540 $900     (   173    000170 35400900     MOV #9,r5 ; ) 9 s#k  5 dRn mov, .lst <0> 
$17E $3540 $FFFF     (   174    000174 3543         MOV #0xFFFF,r5 ; ) $FFFF s#k  5 dRn mov, .lst<0> 
